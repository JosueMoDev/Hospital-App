...
export class Environment {
    ...
    static GOOGLE_CLIENT_KEY: string = get('GOOGLE_CLIENT_KEY').required().asString();
    static GOOGLE_SECRET_KEY: string = get('GOOGLE_SECRET_KEY').required().asString();
    static CLOUDINARY_CLOUD_NAME: string = get('CLOUDINARY_CLOUD_NAME').required().asString();
